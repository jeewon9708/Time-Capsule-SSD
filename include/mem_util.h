...
#define mem_search_min_max(ADDR, UNIT, SIZE, CMD,BANK)		_mem_search_min_max((void*) (ADDR), (UINT32) (UNIT), (UINT32) (SIZE), (UINT32) (CMD), (UINT32) (BANK))
...
UINT32	_mem_search_min_max(const void* const addr, UINT32 const unit, UINT32 const size, UINT32 const cmd,UINT32 const bank);
